...
{
    if ((freq >= 100) && (freq < 200)) band = 1;//1.8
    else
    if ((freq >= 200) && (freq < 390)) band = 2;//3.5
    else
    if ((freq >= 390) && (freq < 740)) band = 3;//7.0
    else
    if ((freq >= 740) && (freq < 1500)) band = 4;//10-14
    else
    if ((freq >= 1500) && (freq < 2200)) band = 5;//18-21
    else
    if ((freq >= 2200) && (freq < 3000)) band = 6;//24-28
	else band = 7;//50-54
	//
	SetBand();
}
...
void SetBand(void)
{
	...
	else
	{
		...
		if (bb == 4) _BAND_1014 = 1;
		else _BAND_1014 = 0;
		if (bb == 5) _BAND_1821 = 1;
		else _BAND_1821 = 0;
		if (bb == 6) _BAND_2428 = 1;
		else _BAND_2428 = 0;
		if (bb == 7) _BAND_50 = 1;
		else _BAND_50 = 0;
	}
